...
const Navbar = () => {
  ...
  return (
    <>
      <div className="container  max-w-screen-2xl  mx-auto px-4 md:px-10 h-16 fixed top-0 left-0 right-0 z-50 text-white bg-pink-300 shadow-md shadow-pink-800/50">
